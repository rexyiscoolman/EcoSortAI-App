...
# MODEL PATH
# =========================
MODEL_PATH = "recycling_model_tf.keras"
IMG_SIZE = (224, 224)
...
if page == "🏠 Home":
    ...
    st.write("Upload a photo and EcoSortAI will classify it into one of **27 categories**.")
    ...
    if uploaded_file is not None:
        ...
        max_cont_prob = max([probs[ALL_CLASSES.index(cls)] for cls in CONTAM_CLASSES])

        if predicted_class in CONTAM_CLASSES or max_cont_prob > (top_prob - CONTAM_BIAS):
    ...
    st.write("EcoSortAI builds AI tools that help communities reduce contamination and improve recycling.")
