...
# PATHS & CLASSES
# =========================
MODEL_PATH = "recycling_model.keras"  # Make sure this file is in the same folder as app.py
IMG_SIZE = (224, 224)
...
def load_model():
    if not os.path.exists(MODEL_PATH):
        st.error(
            ...
            "Please make sure `recycling_model.keras` is uploaded to your project folder."
        )
        st.stop()
    try:
